                            ...
                            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                                ...
                                <div className="flex justify-start">
                                    <button
                                        ...
                                        className="text-sm text-white/30 hover:text-[#d0c8ff] transition-colors"
                                    >
                                        Forgot Password?
                                    </button>
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full rounded-xl py-4 text-lg font-semibold text-white transition-all duration-300 ${isFormValid
