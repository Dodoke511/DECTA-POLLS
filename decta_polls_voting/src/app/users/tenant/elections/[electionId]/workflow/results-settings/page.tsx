...
export default function ResultsSettingsPage() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-1/4 w-[600px] h-[400px] bg-[#4F46E5] rounded-full blur-[180px] opacity-[0.06] pointer-events-none" />
      ...
      <div className="flex items-center gap-2 px-6 py-3 bg-[#140B2D]/80 backdrop-blur-md border-b border-white/8 text-[12px]">
        ...
        <span className="text-[#A78BFA] font-medium">Results Settings</span>
      </div>
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar px-6 pb-12">
        <div className="max-w-3xl mx-auto mt-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-12 h-12 rounded-2xl bg-[#4F46E5]/20 border border-[#4F46E5]/30 flex items-center justify-center">
              <BarChart3 className="w-6 h-6 text-[#A78BFA]" />
            </div>
            <div>
              <h1 className="text-[22px] font-bold text-white/90">Results Settings</h1>
              <p className="text-[13px] text-white/40">Configure results visibility, tallying method, and download access</p>
            </div>
          </div>
          ...
          <div className="rounded-[20px] border border-white/5 bg-[#1C162E]/70 backdrop-blur-xl p-10 flex flex-col items-center justify-center text-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-[#4F46E5]/10 border border-[#4F46E5]/20 flex items-center justify-center">
              <Construction className="w-8 h-8 text-[#A78BFA]/60" />
            </div>
            <div>
              <p className="text-[16px] font-semibold text-white/70">Results Configuration</p>
              <p className="text-[13px] text-white/35 mt-1 max-w-md">
                Tallying method, public visibility controls, results download access, and announcement settings
                will be configurable here. This panel is under active development.
              </p>
            </div>
            <div className="flex flex-wrap gap-3 mt-2 justify-center">
              {['Tallying Method', 'Results Visibility', 'Download Access', 'Announcement Date', 'Tie-breaking Rules'].map(item => (
