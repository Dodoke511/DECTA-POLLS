      ...
      <div className="flex flex-1 overflow-hidden flex-col gap-4 p-4 md:flex-row md:p-6">
        ...
        <main className="min-w-0 flex-1 rounded-[28px] border p-6 shadow-[0_0_60px_rgba(93,68,248,0.15),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-sm md:p-8 overflow-y-auto no-scrollbar h-full" style={{
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(280px,380px)]">
            <section className="rounded-[22px] border p-6 shadow-inner" style={{ background: "rgba(217,217,217,0.09)", border: "1px solid rgba(203,191,255,0.10)" }}>
              <h2 className="mb-6 text-lg font-semibold text-white/90">Subscription Rate</h2>
              <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-10">
                <div className="relative h-52 w-52 shrink-0">
                  <div className="h-full w-full rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_-4px_12px_rgba(0,0,0,0.25)]" style={{ background: "conic-gradient(#a855f7 0deg 140deg, #ef4444 140deg 272deg, #14b8a6 272deg 360deg)" }} />
                ...
                <ul className="flex flex-wrap justify-center gap-4 sm:flex-col sm:gap-3">
                  <li className="flex items-center gap-2 text-sm text-white/80"><span className="h-3 w-3 rounded-full bg-[#a855f7] shadow-[0_0_8px_rgba(168,85,247,0.8)]" />Enterprise</li>
                  <li className="flex items-center gap-2 text-sm text-white/80"><span className="h-3 w-3 rounded-full bg-[#ef4444] shadow-[0_0_8px_rgba(239,68,68,0.6)]" />Standard</li>
                  <li className="flex items-center gap-2 text-sm text-white/80"><span className="h-3 w-3 rounded-full bg-[#14b8a6] shadow-[0_0_8px_rgba(20,184,166,0.7)]" />Basic</li>
                </ul>
              </div>
            </section>

            <div className="flex flex-col gap-4">
              <article className="flex items-start gap-4 rounded-[22px] border px-5 py-5" style={{ background: "rgba(217,217,217,0.09)", border: "1px solid rgba(203,191,255,0.10)", boxShadow: "5px 5px 10px 2px rgba(255,255,255,0.06)" }}>
            ...
            <section className="mt-10 lg:col-span-2 w-full">
              ...
              <div className="relative w-full overflow-x-auto rounded-[22px] bg-white/[0.09] shadow-[5px_5px_10px_2px_rgba(255,255,255,0.06)]">
